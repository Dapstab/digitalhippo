...
var dotenv_1 = __importDefault(require("dotenv")); // Importa dotenv para manejar variables de entorno
var path_1 = __importDefault(require("path")); // Importa el módulo path para trabajar con rutas de archivos
var payload_1 = __importDefault(require("payload")); // Importa payload, el CMS headless
var nodemailer_1 = __importDefault(require("nodemailer"));
dotenv_1.default.config({
    // Configura dotenv para cargar variables de entorno
    path: path_1.default.resolve(__dirname, "../.env"), // Especifica la ruta del archivo .env
});
...
var cached = global.payload; // Crea o recupera una caché global para la instancia de Payload
if (!cached) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _c.client = _d.sent(); // Espera a que Payload se inicialice y guarda el cliente en caché
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _d.sent();
                    cached.promise = null; // Si hay un error, resetea la promesa en caché
                    throw e_1; // Y lanza el error
                case 4: return [2 /*return*/, cached.client]; // Devuelve el cliente de Payload
            }
        });
    });
};
