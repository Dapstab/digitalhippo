...
var express_1 = __importDefault(require("express")); // Importa Express para manejar el servidor HTTP
var get_payload_1 = require("./get-payload"); // Importa función para inicializar Payload CMS
var next_utils_1 = require("./next-utils"); // Importa utilidades de Next.js
...
var app = (0, express_1.default)(); // Crea una instancia de Express
var PORT = Number(process.env.PORT) || 3000; // Define el puerto del servidor, usa variable de entorno o 3000 por defecto
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
                        ...
                        initOptions: {
                            ...
                            onInit: function (cms) { return __awaiter(void 0, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    ...
                                    cms.logger.info("Admin URL ".concat(cms.getAdminURL())); // Muestra la URL del admin de Payload
                                    return [2 /*return*/];
                                });
                            }); },
                        },
            ...
            case 1:
                ...
                app.use(function (req, res) { return (0, next_utils_1.nextHandler)(req, res); }); // Configura el manejador de Next.js para todas las rutas
